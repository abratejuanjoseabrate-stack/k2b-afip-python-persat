"""
Router de padrón - Endpoints REST para WS-SR-PADRON (A5) - PRODUCCIÓN
"""
...
router = APIRouter(prefix="/api/v1/padron", tags=["padron produccion"])


@router.get("/a5", response_model=PadronA5Response)
def consultar_padron_a5_prod(
    ...
    try:
        ...
        service = PadronA5Service(env="prod")
